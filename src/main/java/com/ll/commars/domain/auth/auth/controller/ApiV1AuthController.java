...
import com.ll.commars.domain.auth.auth.service.JwtTokenValidator;
...
public class ApiV1AuthController {
    ...
    public ApiV1AuthController(JwtTokenProvider jwtTokenProvider) {
    ...
    public ResponseEntity<?> login(@RequestBody LoginRequest loginRequest) {
        ...
        if (JwtTokenValidator.validate(loginRequest.getToken())) {

...
public class RestaurantReviewAnalysisDTO {
	...
	public RestaurantReviewAnalysisDTO(Long restaurantId, String restaurantName, int reviewCount, double averageRating,
		double weightedScore, int rank, List<ReviewAnalysisDTO> reviews) {

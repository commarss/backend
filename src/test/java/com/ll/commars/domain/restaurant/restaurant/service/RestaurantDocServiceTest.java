...
public class RestaurantDocServiceTest {
    ...
    class 식당_검색_테스트 {
        ...
        void 키워드와_위치_기반으로_식당을_성공적으로_검색한다() {
            // given
            // 강남역과 신논현역은 1km 이내
            RestaurantSearchRequest request = new RestaurantSearchRequest("교자", SINNONHYEON_LAT, SINNONHYEON_LON, 1000.0);
    ...
    class 근처_식당_검색_테스트 {
        ...
        void setUp() {
            // 기준점: 강남역
            restaurantNear = createRestaurantDoc("가까운 식당", DEFAULT_DESCRIPTION, RestaurantCategory.한식, 37.498, 127.027, 4.0); // 약 200m
            restaurantMid = createRestaurantDoc("중간 식당", DEFAULT_DESCRIPTION, RestaurantCategory.일식, 37.500, 127.030, 4.5); // 약 400m
            restaurantFar = createRestaurantDoc("먼 식당", DEFAULT_DESCRIPTION, RestaurantCategory.중식, 37.505, 127.032, 5.0); // 약 1km
